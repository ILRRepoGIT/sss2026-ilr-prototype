...
The shipped report (`SSS2026_ILR_Report_V4.15_Bilingual.html`, 179,534,432 bytes, sha256 dd5d9959d40c2ed417cdc8eeb937171ff50d3240b690c99583f462ba45891bfd) is a build output reproduced from this repository and the export by the commands in the key documents §3; it is not committed (GitHub's 100 MB file limit) — see the release assets / the owner's Downloads and Data_Report_Outputs.
