...
**Current prototype: V4.16 (22 Sep 2026) — the final prototype with the Young Artists Competition artwork, against Framework v2.9.** V4.15 with the fourteen winning entries in place of the three Brain Break characters, each placed once, each with an alt frame (`ui.alt_yac_*`, English; Welsh pending the translator); every one of the 8,568 narrative states, the static lane and the corpus lock byte-identical to V4.15. The record is the "Build V4.16" entry of `sw-feedback-compliance-record.md`; the open questions `generated/SSS2026_V4.16_Flags_for_confirmation.md`; the artwork pack `inputs/yac images V4.16/`; the placements `config/assets.yml`.

**Real-school round: V5.0 (21 Sep 2026) — the first three real-school reports from the cleansed 2026 dataset, against Framework v2.8; the V4.15 final prototype's pipeline unchanged.** Start with `docs/SSS2026_ILR_Key_Documents_V5.0.md`. (The V5.0 reports carry the Brain Break images; the artwork lands in the school reports when the next round is built from V4.16.)
