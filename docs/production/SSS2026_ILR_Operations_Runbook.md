...
export RELEASE=v6.0-rc11                 # the tag the VM was bootstrapped at (v6.0-rc11 today — Framework v2.19, pipeline 0.32.2; the owner cuts v6.0 with tools/cut_release.sh)
