...
export RELEASE=v6.0-rc12                 # the tag the VM was bootstrapped at (v6.0-rc12 today — Framework v2.20, pipeline 0.32.3; the owner cuts v6.0 with tools/cut_release.sh)
