...
export RELEASE=v6.0-rc10                 # the tag the VM was bootstrapped at (v6.0-rc10 today — Framework v2.18, pipeline 0.32.1; the owner cuts v6.0 with tools/cut_release.sh)
