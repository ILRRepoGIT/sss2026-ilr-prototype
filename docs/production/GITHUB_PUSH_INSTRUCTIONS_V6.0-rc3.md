...
git bundle verify ../sss2026-ilr-prototype_V6.0-rc3_incremental.gitbundle   # "The bundle records a complete history" or lists prerequisite 43bb4b8 — which this clone has
git fetch ../sss2026-ilr-prototype_V6.0-rc3_incremental.gitbundle production/v6.0:production/v6.0
git fetch ../sss2026-ilr-prototype_V6.0-rc3_incremental.gitbundle tag v6.0-rc3

# 3. sanity checks
git merge-base --is-ancestor origin/production/v6.0 production/v6.0 && echo "fast-forward from the pushed rc2: OK"
git log --oneline origin/production/v6.0..production/v6.0                # expect three commits: docs tag lines; handover-review corrections; "Release v6.0-rc3 … (release manifest)"
git describe --tags --exact-match production/v6.0                        # expect v6.0-rc3
git diff --stat origin/production/v6.0 production/v6.0 | tail -1         # about 9 files; nothing under web/, pipeline/, config/
