# -*- coding: utf-8 -*-
# VENDORED VERBATIM from the appraisal deliverable welsh_acceptance_gates.py
# (V4.2 assessment, 28 Aug 2026). Do not edit: the release contract is the
# stock script; pipeline.welsh_gates wraps it. Sheet 36 of Framework v1.6.
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
def gates(R):
    ...
    # --- G4  figure parity --------------------------------------------------
    gate('G4', 'Figure in English with no counterpart in Welsh',
         [r for r in R if numset(r['t'], EN_NUM, True) - numset(r['c'], CY_NUM)])
