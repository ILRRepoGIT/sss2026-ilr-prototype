...
# -*- coding: utf-8 -*-
"""
SSS2026 — Welsh acceptance gates, v6.
...
def selftest():
    ...
    D = {'welsh': {'handoff': {'k1': None}, 'handoffMissing': 5,
                   ...
                   'countNP': {'camp|definite': ['yr un gamp', 'y ddwy gamp', 'y tair camp', 'y pedair camp', 'y pum camp', 'y chwe champ', 'y saith camp', 'yr wyth camp', 'y naw camp', 'y deg camp']},
         ...
         'buildMetadata': {'mode': 'dev', 'gateRunnerVersion': '4.0.0', 'gateManifestHash': '76f4e5ba9585262b', 'welshFramework': 'v1.9', 'welshFrameworkFile': '01_Framework_v2.0.xlsx',
                           'gateResults': {'runner': '5.0.0', 'manifestHash': '318f15f5d8a202d9', 'blockingPass': 53, 'blockingTotal': 53, 'pathsComplete': 18},
...
def main():
    ...
    if claim:
        ...
        if claim[0] is not None and (claim[0] > computed[0] or (claim[2] is not None and claim[2] > computed[2])):
